...
if __name__ == '__main__':
    ...
    # Set up logging
    log_file_path = os.path.join(sys.path[-1], 'exp3', 'CMF', 'Exp_results', Exp_marker, data_name, args.cost_type , 'experiment.log')
    ...
    for seed in range(start,30):
        for mf_model in ["GP_dkl"]:
            for acq in ["UCB","cfKG"]:
                ...
                path_csv = os.path.join(sys.path[-1], 'exp3', 'CMF', 'Exp_results', Exp_marker, data_name, exp_config['cost_type'])
