...
seed_dic = {'himmelblau':[i for i in range(20)],
            'borehole':  [i for i in range(20)],
            'colvile' :  [i for i in range(20)]}
...
plt.tight_layout()
plt.savefig(os.path.join(sys.path[-1], 'Experiment', 'CMF','Graphs') + '/' + 'CMF_diffdata.png', bbox_inches='tight')