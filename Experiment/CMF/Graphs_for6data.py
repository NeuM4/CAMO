...
seed_dic ={
           'Currin':[i for i in range(20)],
           'Branin':[i for i in range(20)],
...
draw_plots(ax6, 'bohachevsky', cmf_methods_name_list)
...
plt.tight_layout()
plt.savefig(os.path.join(sys.path[-1], 'Experiment', 'CMF', 'Graphs') + '/' + 'CMF_SR_6.png', bbox_inches='tight')