...
seed_dic = {'forrester': [range(0, 30)], 'non_linear_sin': [range(0, 30)], 'Branin':[range(0, 30)], 'Currin':[range(0, 30)],'Park':[range(0, 30)],'himmelblau':[range(0, 30)],
            'bohachevsky':[range(0, 30)]}
