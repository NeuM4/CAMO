...
def MF_BO_discrete(exp_config):
    ...
    while flag:
        ...
        if exp_config["Acq_function"] == "UCB":
            ...
            Acq_function = Acq_list[exp_config["Acq_function"]](posterior_function=GP_model,
                                                                data_model=data,
                                                                cost=model_cost,
                                                                fidelity_num=total_fidelity_num,
                                                                data_manager=fidelity_manager,
...
if __name__ == '__main__':
    ...
    # Set up logging
    log_file_path = os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'DMF', 'Exp_results', Exp_marker, data_name, args.cost_type , 'experiment.log')
