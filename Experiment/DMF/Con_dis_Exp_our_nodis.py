...
if __name__ == '__main__':
    ...
    Exp_marker = "improve_our_con-dis"
    
    for seed in range(20):
        for mf_model in ['CMF_CAR']:
            for acq in ["UCB"]:
                # Set up logging
                log_file_path = os.path.join('/home/fillip/桌面/CAMO/Experiment/DMF/Exp_results', Exp_marker, data_name, args.cost_type , f'{mf_model}_experiment_{acq}.log')
                ...
                path_csv = os.path.join("/home/fillip/桌面/CAMO/Experiment/DMF/Exp_results", Exp_marker, data_name, exp_config['cost_type'])
