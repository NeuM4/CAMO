...
if __name__ == '__main__':
    ...
    for seed in range(5):
        for mf_model in ['CMF_CAR', 'CMF_CAR_dkl']:
            for acq in ["UCB",'cfKG']:
                # Set up logging
                log_file_path = os.path.join(sys.path[-1], 'Experiment', 'DMF', 'Exp_results', data_name, args.cost_type , f'{mf_model}_experiment_{acq}.log')
                ...
                exp_config = {
                    ...
                    'initial_index': {0: 3, 1: 3, 2: 3, 3: 3, 4: 3, 5: 3, 6: 3, 7: 3, 8: 3, 9: 3}, #Discrete 10 fidelity
                    'MF_iterations': 200,
                ...
                path_csv = os.path.join(sys.path[-1], 'Experiment', 'DMF', 'Exp_results', data_name, exp_config['cost_type'])
