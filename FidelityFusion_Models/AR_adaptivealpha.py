...
def train_ARaa(ARmodel, data_manager, max_iter=1000, lr_init=1e-1, normal = True, debugger=None):
...
if __name__ == "__main__":
    ...
    train_ARaa(myAR, fidelity_manager, max_iter=200, lr_init=1e-2, debugger = None)
