...
from Model_validation.Load_Mfdata import get_full_name_list_with_fidelity
...
Dic = {'AR': ['#ff7f0e', "o", "solid", "AR"],
       ...
       'CIGAR': ['#1f77b4', "o", "dashed", "CIGAR"],
        ...
        'CMF_CAR_dkl': ['#e377c2', "o", "dashed", "CMF_CAR_dkl"],
        'CMF_CAR': ['#bcbd22', "o", "dashed", "CMF_CAR"],
        }
...
methods_name_list = ['AR','ResGP','NAR','GAR','DMF_CAR','CMF_CAR','CMF_CAR_dkl']
# test_name_list = ["forrester",
#                           "tl1", "tl2", "tl3", "tl4", "tl5", "tl6", "tl7", "tl8", "tl9", "tl10",
#                           "p1", "p2", "p3", "p4", "p5",
#                           "maolin1", "maolin5", "maolin6", "maolin7", "maolin8", "maolin10", "maolin12", "maolin13",
#                           "maolin15",
...
#                           "test3", "test4", "test5", "test6", "test7"]
test_name_list = ["tl1", "tl2", "tl3", "tl4"]
