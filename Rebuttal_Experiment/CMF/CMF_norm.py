...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_name", type=str, default="colvile")
    ...
    # Set up logging
    log_file_path = os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'CMF', 'Exp_results', Exp_marker, data_name, args.cost_type , 'experiment.log')
        ...
        for mf_model in ["CMF_CAR","CMF_CAR_dkl",]:
            for acq in ["cfKG"]:
                try:
                    ...
                    path_csv = os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'CMF', 'Exp_results', Exp_marker, data_name, exp_config['cost_type'])
