...
lim_x = {'VibratePlate2': [50, 150], 'HeatedBlock': [50, 150]}
for kk in range(2):
...
plt.tight_layout()
plt.savefig(os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'CMF', 'Graph_show') + '/' + 'CMF_real_' + cost_name +'_Rebuttal_cost.pdf', bbox_inches='tight')
plt.savefig(os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'CMF', 'Graph_show') + '/' + 'CMF_real_' + cost_name +'_Rebuttal_cost.eps', bbox_inches='tight')