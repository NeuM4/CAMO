...
lim_x = {'VibratePlate2': [30, 150], 'HeatedBlock': [48, 150]}
...
cmf_methods_name_list = ['GP_UCB', 'GP_cfKG', 
                         ...
                         'CMF_CAR_dkl_UCB', 'CMF_CAR_dkl_cfKG','smac']
...
for kk in range(2):
    ...
    for methods_name in baseline_list:
        ...
        for seed in baseline_seed_dic[data_name]:
...
plt.tight_layout()
plt.savefig(os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'CMF', 'Graph_show') + '/' + 'CMF_real_' + cost_name +'_SR_together_4.pdf', bbox_inches='tight')