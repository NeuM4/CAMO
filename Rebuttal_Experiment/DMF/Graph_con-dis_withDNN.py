...
lim_y = {'forrester': [0, 52], 'non_linear_sin': [0.007, 0.034],'Currin':[0,2],'Park':[0,1.2],'Branin':[0,15]}
...
data_name = 'Currin'  # 将 data_name 提升到外部，因为它在循环中没有变化
Exp_marker = "Norm_res"
cost_name = 'pow_10'
...
# plt.show()
plt.savefig(os.path.join(sys.path[-1], 'Rebuttal_Experiment', 'DMF', 'Graphs') + '/' +'Con-dis-' + Exp_marker+ data_name + '_SR_DNN.pdf', bbox_inches='tight')
